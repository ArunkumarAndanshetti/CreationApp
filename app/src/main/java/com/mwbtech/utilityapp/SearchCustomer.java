...
public class SearchCustomer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fm.getMapAsync(this::onMapReady);
    ...
    private class ReadTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... url) {
            ...
            try {
                ...
                Log.i("Background Data", data.toString());
            } catch (Exception e) {
